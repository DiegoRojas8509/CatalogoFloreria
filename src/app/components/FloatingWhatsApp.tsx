...
export default function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="absolute inset-0 rounded-full bg-olive animate-pulse-ring"
      />
      <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="relative z-10">
